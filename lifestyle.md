A report for lifestyle channel
================
...
```
    ...
    ##                               Means        StdDev
    ## LDA_02                   0.08077064    0.11236722
    ## avg_negative_polarity   -0.26344273    0.10966807
    ## average_token_length     4.55744750    0.66582234
    ## max_negative_polarity   -0.10713716    0.09369452
    ## kw_max_avg            6584.60806639 6564.89576518
    ## LDA_03                   0.13871219    0.19444450
    ## kw_avg_avg            3383.53547853 1290.83691192
    ## shares                3540.52791069 5983.76573017
...
![](lifestyle_files/figure-gfm/unnamed-chunk-5-4.png)<!-- -->
...
![](lifestyle_files/figure-gfm/unnamed-chunk-5-5.png)<!-- -->
...
![](lifestyle_files/figure-gfm/unnamed-chunk-5-6.png)<!-- -->
...
![](lifestyle_files/figure-gfm/unnamed-chunk-5-7.png)<!-- -->
...
```
    ...
    ##   <chr>  <dbl>    <dbl> <dbl>
    ## 1 fullLM 5934.  0.0193  3116.
    ## 2 fwdFit 5973.  0.00737 3141.
    ## 3 rfFit  6081.  0.00631 3224.
    ## 4 gbmFit 6044.  0.00437 3249.
